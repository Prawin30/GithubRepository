...
@CartTest
  Scenario: User adds a product to the cart
    Given I am on the product page "https://www.saucedemo.com"
...
@CheckoutTest
  Scenario: User completes the checkout process
    Given I am on the checkout page "https://www.saucedemo.com/checkout-step-one.html"
...
@FilterTest
  Scenario: User applies product filters
    Given I am on the product filter page "https://www.saucedemo.com/inventory.html"
 ...
 @PurchaseTest
  Scenario: User completes an e-commerce product purchase
    Given I am on the e-commerce site "https://www.saucedemo.com"
